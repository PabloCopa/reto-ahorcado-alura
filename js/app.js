'use strict'
const palabras = ['ALURA', 'SCRIPT','GITHUB','VISUAL','ESTUDIO','CONSOLA','ADMIN','ESTILO','CASCADA','CABALLO','OVEJA','CABRA','AUDIO','SONIDO','PROFETA','KATANA','ORACLE','JUEGO','PROGRAMA','GRATUITO','YOUTUBE','DIRECTO'];
